...
public class adminRegistrationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          AdminRegistration admin=new AdminRegistration(adminName, adminMobile, adminEmail, adminPassword);
          ...
          String content;
            ...
            if (check != null) {
                boolean register = adminData.registerAdmin(admin);

                if (register) {
//                Registration Successfull
                    content = "Admin  Registered Successfully Completed";
                    color = "green";
                    icon = "fa-check";
