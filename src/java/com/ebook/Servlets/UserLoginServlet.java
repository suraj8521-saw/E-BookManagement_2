...
public class UserLoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            UserRegistration user = userData.getUserDetailsByUserEmailandUserPasward(userEmail, userPassword);
            String content;
            String color;
            String icon;
            Message mymessage;
...
//                Login Success
                ...
                response.sendRedirect("ViewAllBookHomeServlet");
            } else {
                UserRegistration user2 = userData.getUserDetailsByUserEmail(userEmail);
                if (user2 != null) {
