...
<!-- <div class="chat-wrapper">
    <div class="chat-container">
        ...
        <div class="chat-body "  style=" color: red"id="messages">
             Messages go here 
        </div>
        <div class="chat-footer">
            <input type="text" placeholder="Type..." id="msgInput">
...
<!--//script to call function again and again-->
...
<script>
    ...
    function myFunction() {
        ...
        loadMessages(<%=user.getRegisterId()%>);
    }
